namespace DomainServices
{
    ...
    public class FakeReadOnlyRepository<TEntity, TId> : IReadOnlyRepository<TEntity, TId> where TEntity : IEntity<TId>
    {
        private readonly Dictionary<TId, TEntity> _entities = new Dictionary<TId, TEntity>();

        /// <summary>
        /// Initializes a new instance of the <see cref="FakeReadOnlyRepository{TEntity, TId}"/> class.
        /// </summary>
